 ...
 */
final class Version20240607013501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, crated_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, totale DOUBLE PRECISION NOT NULL, status VARCHAR(255) NOT NULL, remarque LONGTEXT DEFAULT NULL, INDEX IDX_6EEAA67DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
